...
\newcommand{\preddistdefsingle}{\normal(\kstar^{T}\Kmat^{-1}\fv, \kstarstar - \kstar^T \Kmat ^{-1}\kstar)} % Gaussian distribution for single pred
\newcommand{\preddist}{f_{\ast} ~|~ \Xmat_{\ast}, \Xmat, \fv} % predictive distribution
\newcommand{\preddistdef}{\normal(\Kstar^{T}\Kmat^{-1}\fv, \Kstarstar - \Kstar^T \Kmat ^{-1}\Kstar)} % Gaussian predictive distribution
