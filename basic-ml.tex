...
\newcommand{\xij}{x^{(i)}_j}                                                % x^i_j, j-th feature value of i-th observation
...
\newcommand{\fbayes}{f^\ast} % The Bayes optimal model
\newcommand{\fxbayes}{f^\ast(\mathbf{x})} % The Bayes optimal model
...
\newcommand{\hbayes}{h^\ast} % The Bayes optimal model
\newcommand{\hxbayes}{h^\ast(\mathbf{x})} % The Bayes optimal model
...
\newcommand{\pix}{\pi(\mathbf{x})}
                                                   % pi(x), P(y = 1 | x)
\newcommand{\pibayes}{\pi^\ast} % The Bayes optimal model
\newcommand{\pixbayes}{\pi^\ast(\mathbf{x})} % The Bayes optimal model
...
\newcommand{\pih}{\hat{\pi}}												% pi hat, estimated 
...
\newcommand{\res}{r}                                                 % residual, empirical
\newcommand{\resi}{r^{(i)}}                                          % epsilon^i, residual, empirical
...
\newcommand{\Lxyitt}{L\left(\yi, f\left(\xv~|~\thetat\right)\right)}                               % L(y^i, f(x^i | theta^[t])
