...
\newcommand{\setAllDatasets}{\bigcup_{n \in \N}(\Xspace \times \Yspace)^n}        % The set of all datasets 
\newcommand{\preimageLearner}{\left(\setAllDatasets\right)\times\bm{\Lambda}}     % Set of all datasets times the hyperparameter space
