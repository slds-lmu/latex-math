...
\newcommand{\fxt}{f(\xb | \theta)}                                            % f(x | theta)
\newcommand{\fxi}{f\left(\xi\right)}                                        % f(x^(i))
\newcommand{\fxih}{\hat{f}\left(\xi\right)}                                 % f(x^(i))
\newcommand{\fxit}{f\left(\xi ~|~ \theta\right)}                          % f(x^(i) | theta)
...
\newcommand{\hxt}{h(\xb | \theta)}                                            % h(x | theta)
\newcommand{\hxi}{h\left(\xi\right)}                                        % h(x^(i))
\newcommand{\hxit}{h\left(\xi | \theta\right)}                          % h(x^(i) | theta)
...
\newcommand{\thetab}{\mathbf{\theta}}											% theta vector
\newcommand{\thetabh}{\mathbf{\hat\theta}}											% theta vector
