...
\newcommand{\thetahDnlambda}{\thetabh{\Dn, \lamv}} %theta learned on Dn with hp lambda
\newcommand{\thetahDlambda}{\thetabh{\D, \lamv}} %theta learned on D with hp lambda
...
\newcommand{\Lxym}{L\left(\yi, f\left(\bm{\tilde{x}}^{(i)} ~|~ \bm{\theta}\right)\right)} % loss of observation with f parameterized
