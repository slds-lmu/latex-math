...
\newcommand{\xiv}{\mathbf{x}^{(i)}}												% bold xi (vector)
...
\newcommand{\ftruex}{f_{\text{true}}(x)}										  % True underlying function (if a statistical model is assumed)
...
\newcommand{\thetav}{\mathbf{\theta}}											% theta vector
