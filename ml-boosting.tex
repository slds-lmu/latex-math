...
\newcommand{\bmmxth}{b(\mathbf{x},\bm{\theta}^{[m]})}                           % basemodel of x and theta m
...
\newcommand{\thetam}{\bm \theta^{[m]}}                                    % parameters of basemodel m
\newcommand{\thetamh}{\hat{\bm \theta}^{[m]}}                             % parameters of basemodel m with hat
...
\newcommand{\Lxyim}{L\left(\yi, f^{[m-1]}(\xi)\right)}