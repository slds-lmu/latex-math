...
\newcommand{\tunerfull}{\tuner_{\inducer,\LamS, \rho,\JJ}} % tuner with inducer, search space, performance measure and resampling strategy
...
\newcommand{\lamfidl}{\lamfid^{\textrm{low}}} % single lambda_budget komponent HP
\newcommand{\lamfidu}{\lamfid^{\textrm{upp}}} % single lambda_budget komponent HP
