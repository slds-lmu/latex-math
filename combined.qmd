...
% math spaces
\ifdefined\N
\renewcommand{\N}{\mathbb{N}} % N, naturals
\else \newcommand{\N}{\mathbb{N}} \fi
\newcommand{\Z}{\mathbb{Z}} % Z, integers
\newcommand{\Q}{\mathbb{Q}} % Q, rationals
\newcommand{\R}{\mathbb{R}} % R, reals
\ifdefined\C
...
\newcommand{\Xv}{\mathbf{X}} % vector X (bold) for random variables
\newcommand{\Yv}{\mathbf{Y}} % vector Y (bold) for random variables
...
%%%%%% ml - models general
\newcommand{\lamv}{\boldsymbol{\lambda}} % lambda vector, hyperconfiguration vector
...
\newcommand{\thetav}{\boldsymbol{\theta}} % theta vector
\newcommand{\thetavh}{\boldsymbol{\hat\theta}} % theta vector hat
...
\newcommand{\piv}{\boldsymbol{\pi}} % pi, bold, as vector
...
\newcommand{\muv}{\boldsymbol{\mu}} % expectation vector of Gaussian
\newcommand{\muk}[1][k]{\boldsymbol{\mu_{#1}}} % mean vector of class-k Gaussian (discr analysis)
\newcommand{\mukh}[1][k]{\boldsymbol{\hat{\mu}_{#1}}} % estimated mean vector of class-k Gaussian (discr analysis)

% residual and margin
\newcommand{\rx}{r(\xv)} % residual 
\newcommand{\eps}{\epsilon} % residual, stochastic
\newcommand{\epsv}{\boldsymbol{\epsilon}} % residual, stochastic, as vector
...
\newcommand{\Lxym}{L\left(\yi, f\left(\boldsymbol{\tilde{x}}^{(i)} ~|~ \thetav\right)\right)} % loss of observation with f parameterized
...
\newcommand{\Xsubset}{\boldsymbol{X}} % bold X, finite subset from xspace
...
% \thetav is \boldsymbol{\theta}}  (theta vector)
...
\newcommand{\Lxdi}{L\left(\boldsymbol{\delta}, \fx\right)}           
...
\newcommand{\alphav}{\boldsymbol{\alpha}} % vector alpha (bold) (basis fun coefficients)
\newcommand{\alphavh}{\hat{\boldsymbol{\alpha}}} % vector alpha-hat (basis fun coefficients)
